...
## SW
##============================================================
set_location_assignment PIN_AB30 -to sw0
...
set_location_assignment PIN_AC29 -to sw8
...
set_location_assignment PIN_AC22 -to test_led_out
#
##============================================================
## Seg7
##============================================================
set_location_assignment PIN_W17 -to  hex_first[0]
set_location_assignment PIN_V18 -to  hex_first[1]
set_location_assignment PIN_AG17 -to hex_first[2]
set_location_assignment PIN_AG16 -to hex_first[3]
set_location_assignment PIN_AH17 -to hex_first[4]
set_location_assignment PIN_AG18 -to hex_first[5]
set_location_assignment PIN_AH18 -to hex_first[6]
set_location_assignment PIN_AF16 -to hex_second[0]
set_location_assignment PIN_V16 -to  hex_second[1]
set_location_assignment PIN_AE16 -to hex_second[2]
set_location_assignment PIN_AD17 -to hex_second[3]
set_location_assignment PIN_AE18 -to hex_second[4]
set_location_assignment PIN_AE17 -to hex_second[5]
set_location_assignment PIN_V17 -to  hex_second[6]
set_location_assignment PIN_AA21 -to hex_third[0]
set_location_assignment PIN_AB17 -to hex_third[1]
set_location_assignment PIN_AA18 -to hex_third[2]
set_location_assignment PIN_Y17 -to  hex_third[3]
set_location_assignment PIN_Y18 -to  hex_third[4]
set_location_assignment PIN_AF18 -to hex_third[5]
set_location_assignment PIN_W16 -to  hex_third[6]
...
set_location_assignment PIN_AD21 -to song_speed[0]
set_location_assignment PIN_AG22 -to song_speed[1]
set_location_assignment PIN_AE22 -to song_speed[2]
set_location_assignment PIN_AE23 -to song_speed[3]
set_location_assignment PIN_AG23 -to song_speed[4]
set_location_assignment PIN_AF23 -to song_speed[5]
set_location_assignment PIN_AH22 -to song_speed[6]
set_location_assignment PIN_AF21 -to volume[0]
set_location_assignment PIN_AG21 -to volume[1]
set_location_assignment PIN_AF20 -to volume[2]
set_location_assignment PIN_AG20 -to volume[3]
set_location_assignment PIN_AE19 -to volume[4]
set_location_assignment PIN_AF19 -to volume[5]
set_location_assignment PIN_AB21 -to volume[6]
#
##============================================================
## SDRAM
##============================================================
